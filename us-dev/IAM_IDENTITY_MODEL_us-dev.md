...
- ECS backend module: [us-dev/main.tf](us-dev/main.tf#L60)
- GitHub OIDC module: [us-dev/main.tf](us-dev/main.tf#L86)

## 2) Danh sách role đã tạo trên state us-dev

Theo state hiện tại:

- xbrain-ecs-instance-us-dev: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1190)
- xbrain-ecs-exec-us-dev: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1232)
- xbrain-ecs-task-us-dev: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1272)
- xbrain-gha-oidc-us-dev: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1766)
...
- Bằng chứng state: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1179)
...
- Bằng chứng state managed_policy_arns: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1185)
...
- Bằng chứng state: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1222)
...
- Bằng chứng state: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1228)
...
- Bằng chứng state: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1264)

Policy gắn vào role:

- Hiện tại chưa gắn managed policy và chưa có inline policy.
- Bằng chứng state managed_policy_arns rỗng: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1270)
...
- Bằng chứng state trust: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1753)
...
- Bằng chứng state inline policy: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1798)
...
- EC2 launch template gắn instance profile thay vì key tĩnh:
  ...
  - Bằng chứng state profile-role: [us-dev/terraform.tfstate](us-dev/terraform.tfstate#L1149)
